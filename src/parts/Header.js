...
export default function Header() {
	...
	return (
		<nav className="bg-white p-3 shadow md:flex md:items-center md:justify-between fixed top-0 left-0 w-screen ">
			...
			>
				...
				<button className="bg-transparent border border-black hover:bg-blue-300 px-6 py-1 text-black duration-500 mx-4 font-heading rounded-sm text-xl mb-4 mt-4 md:mt-0 md:mb-0 hover:text-blue-800">
